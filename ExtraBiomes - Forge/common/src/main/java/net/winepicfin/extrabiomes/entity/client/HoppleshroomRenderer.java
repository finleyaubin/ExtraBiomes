...
public class HoppleshroomRenderer extends MobRenderer<HoppleshroomEntity, HoppleshroomModel<HoppleshroomEntity>> {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(HoppleshroomEntity entity) {
