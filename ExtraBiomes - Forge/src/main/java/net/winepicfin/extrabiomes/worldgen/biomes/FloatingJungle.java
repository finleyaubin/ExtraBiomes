...
public class FloatingJungle {
    ...
    public Biome Register(BootstapContext<Biome> context)
    {
        ...
        // NOTE: floating islands use the SKY_LOG/SKY_LEAVES tree (previously unused) instead of jungle trees,
        // see ModPlacedFeatures.SKY_PLACED_KEY (added).
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.SKY_PLACED_KEY);
        ...
        // underground_jungle: jungle_after_surface select-moss-or-tree chain
