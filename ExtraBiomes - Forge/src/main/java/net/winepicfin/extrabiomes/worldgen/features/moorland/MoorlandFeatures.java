...
public class MoorlandFeatures {
    ...
    public static final RegistryObject<PodzolConversionFeature> PODZOL_CONVERSION_FEATURE =
            FEATURES.register("moorland_podzol_conversion", () -> new PodzolConversionFeature(NoneFeatureConfiguration.CODEC));
    public static final RegistryObject<DoubleTallGrassFeature> DOUBLE_TALL_GRASS_FEATURE =
            FEATURES.register("moorland_double_tall_grass", () -> new DoubleTallGrassFeature(NoneFeatureConfiguration.CODEC));
    public static final RegistryObject<WaterLilyFixupFeature> WATERLILY_FIXUP_FEATURE =
