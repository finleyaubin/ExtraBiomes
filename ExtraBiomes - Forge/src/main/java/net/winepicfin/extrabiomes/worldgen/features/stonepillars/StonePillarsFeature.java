...
public class StonePillarsFeature {
    ...
    public static void bootstrapConfigured(BootstapContext<ConfiguredFeature<?, ?>> context) {
        context.register(STONE_PILLAR_1_KEY, new ConfiguredFeature<>(
                ...
                new SingleStructureConfiguration(ResourceLocation.fromNamespaceAndPath(ExtraBiomes.MOD_ID, "stone_pillars/stone_pillar_1"), GROUND_OFFSET)
        ));
        context.register(STONE_PILLAR_2_KEY, new ConfiguredFeature<>(
                ModStructureScatterFeatures.SINGLE_STRUCTURE.get(),
                new SingleStructureConfiguration(ResourceLocation.fromNamespaceAndPath(ExtraBiomes.MOD_ID, "stone_pillars/stone_pillar_2"), GROUND_OFFSET)
        ));
        context.register(STONE_PILLAR_3_KEY, new ConfiguredFeature<>(
                ModStructureScatterFeatures.SINGLE_STRUCTURE.get(),
                new SingleStructureConfiguration(ResourceLocation.fromNamespaceAndPath(ExtraBiomes.MOD_ID, "stone_pillars/stone_pillar_3"), GROUND_OFFSET)
        ));
