...
// Fabric port of forge/datagen/ModRecipeProvider.java. Forge's IConditionBuilder interface is never
// actually used for its methods there (Forge recipe JSON conditions are all vestigial in that class),
// so it's simply dropped here - everything else is identical vanilla RecipeProvider logic, just
// extending Fabric API's FabricRecipeProvider (constructor takes FabricDataOutput) instead of Forge's
// plain PackOutput-taking RecipeProvider.
