...
public class ExtraBiomesFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityModelLayerRegistry.registerModelLayer(ModModelLayers.MYSTIC_BOAT, BoatModel::createBodyModel);
        EntityModelLayerRegistry.registerModelLayer(ModModelLayers.MYSTIC_CHEST_BOAT, ChestBoatModel::createBodyModel);
        EntityModelLayerRegistry.registerModelLayer(ModModelLayers.PALM_BOAT, BoatModel::createBodyModel);
        EntityModelLayerRegistry.registerModelLayer(ModModelLayers.PALM_CHEST_BOAT, ChestBoatModel::createBodyModel);
        EntityModelLayerRegistry.registerModelLayer(ModModelLayers.SKY_BOAT, BoatModel::createBodyModel);
        EntityModelLayerRegistry.registerModelLayer(ModModelLayers.SKY_CHEST_BOAT, ChestBoatModel::createBodyModel);
        EntityModelLayerRegistry.registerModelLayer(ModModelLayers.GILDED_SKY_BOAT, BoatModel::createBodyModel);
        EntityModelLayerRegistry.registerModelLayer(ModModelLayers.GILDED_SKY_CHEST_BOAT, ChestBoatModel::createBodyModel);
        ...
        EntityRendererRegistry.register(ModEntities.MYSTIC_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.MYSTIC_BOAT, ResourceLocation.fromNamespaceAndPath(ExtraBiomes.MOD_ID, "textures/entity/boat/boat_mystic.png"), false));
        EntityRendererRegistry.register(ModEntities.MYSTIC_CHEST_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.MYSTIC_CHEST_BOAT, ResourceLocation.fromNamespaceAndPath(ExtraBiomes.MOD_ID, "textures/entity/chest_boat/boat_mystic.png"), true));
        EntityRendererRegistry.register(ModEntities.PALM_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.PALM_BOAT, ResourceLocation.fromNamespaceAndPath(ExtraBiomes.MOD_ID, "textures/entity/boat/boat_palm.png"), false));
        EntityRendererRegistry.register(ModEntities.PALM_CHEST_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.PALM_CHEST_BOAT, ResourceLocation.fromNamespaceAndPath(ExtraBiomes.MOD_ID, "textures/entity/chest_boat/boat_palm.png"), true));
        EntityRendererRegistry.register(ModEntities.SKY_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.SKY_BOAT, ResourceLocation.fromNamespaceAndPath(ExtraBiomes.MOD_ID, "textures/entity/boat/boat_sky.png"), false));
        EntityRendererRegistry.register(ModEntities.SKY_CHEST_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.SKY_CHEST_BOAT, ResourceLocation.fromNamespaceAndPath(ExtraBiomes.MOD_ID, "textures/entity/chest_boat/boat_sky.png"), true));
        EntityRendererRegistry.register(ModEntities.GILDED_SKY_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.GILDED_SKY_BOAT, ResourceLocation.fromNamespaceAndPath(ExtraBiomes.MOD_ID, "textures/entity/boat/boat_gilded_sky.png"), false));
        EntityRendererRegistry.register(ModEntities.GILDED_SKY_CHEST_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.GILDED_SKY_CHEST_BOAT, ResourceLocation.fromNamespaceAndPath(ExtraBiomes.MOD_ID, "textures/entity/chest_boat/boat_gilded_sky.png"), true));
