...
// Fabric equivalent of neoforge/gametest/BlockGridGameTests.java - nothing here needs real chunk
// generation, just registry iteration and blockstate placement, so it runs fine on Fabric's flat
// GameTestServer.
//
