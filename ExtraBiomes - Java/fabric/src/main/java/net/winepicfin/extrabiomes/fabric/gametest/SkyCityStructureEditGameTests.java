...
// Fabric equivalent of neoforge/gametest/SkyCityStructureEditGameTests.java - nothing here needs
// real chunk generation (unlike StructureGenerationGameTests), just template placement, so it runs
// fine on Fabric's flat GameTestServer.
//
...
public class SkyCityStructureEditGameTests {
    ...
    // still runs harmlessly under Fabric's blanket "run every registered test" boot (it always
