...
public class ModBiomeModifiers {
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_LUSH_GRASS, new BiomeModifiers.AddFeaturesBiomeModifier(biomes.getOrThrow(ModTags.Biomes.LUSH_MESA),
        ...
        context.register(ADD_UNDERGROUND_JUNGLE_VEGETATION, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_UNDERGROUND_JUNGLE_CAVE_VINES, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_JUNGLE),
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(NeoForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(ExtraBiomes.MOD_ID, name));
    }
}
