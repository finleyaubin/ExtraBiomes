package net.winepicfin.extrabiomes.neoforge.block.custom;
    ...
    public @Nullable BlockState getToolModifiedState(BlockState state, UseOnContext context, ToolAction toolAction, boolean simulate) {
        if (context.getItemInHand().getItem() instanceof AxeItem) {
            ...
            if (state.is(ModBlocks.SKY_LOG.get())) {
                return ModBlocks.STRIPPED_SKY_LOG.get().defaultBlockState().setValue(AXIS, state.getValue(AXIS));
            }
            ...
            if (state.is(ModBlocks.GILDED_SKY_WOOD.get())) {
                return ModBlocks.STRIPPED_GILDED_SKY_WOOD.get().defaultBlockState().setValue(AXIS, state.getValue(AXIS));
            }
        }
