...
public class ExtraBiomesForge
{
    ...
    public static class ClientModEvents
    {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            ...
            EntityRenderers.register(ModEntities.MYSTIC_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.MYSTIC_BOAT, new ResourceLocation(ExtraBiomes.MOD_ID, "textures/entity/boat/boat_mystic.png"), false));
            EntityRenderers.register(ModEntities.MYSTIC_CHEST_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.MYSTIC_CHEST_BOAT, new ResourceLocation(ExtraBiomes.MOD_ID, "textures/entity/chest_boat/boat_mystic.png"), true));
            EntityRenderers.register(ModEntities.PALM_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.PALM_BOAT, new ResourceLocation(ExtraBiomes.MOD_ID, "textures/entity/boat/boat_palm.png"), false));
            EntityRenderers.register(ModEntities.PALM_CHEST_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.PALM_CHEST_BOAT, new ResourceLocation(ExtraBiomes.MOD_ID, "textures/entity/chest_boat/boat_palm.png"), true));
            EntityRenderers.register(ModEntities.SKY_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.SKY_BOAT, new ResourceLocation(ExtraBiomes.MOD_ID, "textures/entity/boat/boat_sky.png"), false));
            EntityRenderers.register(ModEntities.SKY_CHEST_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.SKY_CHEST_BOAT, new ResourceLocation(ExtraBiomes.MOD_ID, "textures/entity/chest_boat/boat_sky.png"), true));
            EntityRenderers.register(ModEntities.GILDED_SKY_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.GILDED_SKY_BOAT, new ResourceLocation(ExtraBiomes.MOD_ID, "textures/entity/boat/boat_gilded_sky.png"), false));
            EntityRenderers.register(ModEntities.GILDED_SKY_CHEST_BOAT.get(), ctx -> new ModBoatRenderer(ctx, ModModelLayers.GILDED_SKY_CHEST_BOAT, new ResourceLocation(ExtraBiomes.MOD_ID, "textures/entity/chest_boat/boat_gilded_sky.png"), true));
        }
    }
}
