...
public class SpawnEggItemGameTests {
    ...
    public static void everySpawnEggResolvesRequiredFeaturesWithoutThrowing(GameTestHelper helper) {
        ...
        for (Item item : spawnEggs) {
            ...
            helper.assertTrue(item instanceof DeferredSpawnEggItem, item + " is not a DeferredSpawnEggItem");
            ...
            // with a public API - the instanceof/requiredFeatures()/getType(null) checks above are
            // the coverage available on this platform.
        }
