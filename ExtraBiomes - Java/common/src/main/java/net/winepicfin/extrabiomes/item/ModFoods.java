...
public class ModFoods {
    public static final FoodProperties FROGS_LEGS = new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).effect(new MobEffectInstance(MobEffects.JUMP,600,1),0.8F).build();
    ...
    public static final FoodProperties JELLYFISH_JAM = new FoodProperties.Builder().nutrition(4).saturationModifier(0.3f).effect(new MobEffectInstance(MobEffects.POISON,100,0),0.3F).build();
