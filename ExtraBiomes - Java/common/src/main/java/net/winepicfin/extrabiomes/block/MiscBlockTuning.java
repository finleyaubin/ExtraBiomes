...
// Values ported from standalone Bedrock blocks (ExtraBiomes - Bedrock/packs/BP/blocks/); deliberately has no Minecraft imports so tests can read values without a bootstrapped registry.
public final class MiscBlockTuning {
    ...
    // blocks/mushrooms/glow_mushroom_block.json: minecraft:light_emission (same 0-15 scale as Java's light level).
