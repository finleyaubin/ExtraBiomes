...
public abstract class CommonRecipes extends RecipeProvider {
    ...
    private static void boatRecipes(Consumer<FinishedRecipe> recipeOutput, Block plank, Item boat, Item chestBoat) {
    ...
    private static void grassStoneRecipe(Consumer<FinishedRecipe> recipeOutput) {
