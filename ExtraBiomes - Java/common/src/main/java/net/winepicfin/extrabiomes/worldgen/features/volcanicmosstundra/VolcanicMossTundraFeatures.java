...
public class VolcanicMossTundraFeatures {
    ...
    public static final TagKey<Block> VOLCANIC_TUNDRA_BANK_REPLACEABLE =
            TagKey.create(Registries.BLOCK, new ResourceLocation(ExtraBiomes.MOD_ID, "volcanic_moss_tundra_bank_replaceable"));
    public static final TagKey<Block> VOLCANIC_TUNDRA_MOSS_FLOOR_REPLACEABLE =
            TagKey.create(Registries.BLOCK, new ResourceLocation(ExtraBiomes.MOD_ID, "volcanic_moss_tundra_moss_floor_replaceable"));
