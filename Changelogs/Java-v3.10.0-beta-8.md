...
## Misc
- Fixed each loader's data generation deleting the others' generated files, which could ship Forge/NeoForge jars without their biome modifiers and Fabric jars without their `c:` biome tags.
