...
public class ModBlocks {
   ...
   public static final RegistryObject<Block> DENSE_CLOUD_BLOCK = registerBlock("dense_cloud",()->new Block(BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).sound(SoundType.FROGSPAWN)));
