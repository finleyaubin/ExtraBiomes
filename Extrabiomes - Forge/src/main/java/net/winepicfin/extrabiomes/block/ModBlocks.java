...
public class ModBlocks {
   ...
   public static final RegistryObject<Block> NETHER_DIAMOND_ORE = registerBlock("the_netherlands/nether_diamond_ore",()-> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.NETHERRACK).strength(2f).requiresCorrectToolForDrops(), UniformInt.of(3,7)));
